...
<body class="bg-gray-100">
    <div class="min-h-screen flex flex-col">
        ...
        <main class="main-content container mx-auto">
            <div class="card">
                <h2>Edit Petugas</h2>
                <form action="{{ route('petugas_gudang.update', $petugasGudang->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                        <label for="name">Name</label>
                        <input type="text" id="name" name="name" value="{{ $petugasGudang->name }}" required>
                    </div>
                    <div class="form-group">
                        <label for="email">Email</label>
                        <input type="email" id="email" name="email" value="{{ $petugasGudang->email }}" required>
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" class="submit-button">Update Petugas</button>
                </form>
            </div>
        </main>
    </div>
