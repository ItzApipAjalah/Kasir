        ...
        <nav class="navbar shadow-md">
            ...
            <div class="bg-gray-50 border-t border-gray-200">
                <div class="container mx-auto flex space-x-4 p-4">
                    <a href="{{ route('admin.dashboard') }}" class="text-blue-500 font-semibold border-b-2 border-blue-500 active">Dashboard</a>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.querySelectorAll('.item-card').forEach(card => {
                card.addEventListener('click', () => {
                    ...
                    if (selectedItems[namaProduk]) {
                        selectedItems[namaProduk].quantity++;
                    } else {
                        selectedItems[namaProduk] = {
                            namaProduk,
                            harga,
                            quantity: 1
                        };
